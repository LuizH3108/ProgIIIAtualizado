...
<section>
   ...
   <div class="col-lg-6 col-sm-6">
      <form method="post" action="logic/processarUsuario.php">
         ...
         <label>Nome:</label><br/>
         <input type="text" name="nome" size="30" value="<?=$nome ?>" class="form-control" maxlength="50"
                placeholder="Nome" required="true"/><br/>
         <label>E-mail:</label><br/>
         <input type="email" placeholder="E-mail" name="email" size="30" value="<?=$email ?>"  maxlength="100"
                class="form-control" required="true"/><br/>
         <label>Senha:</label><br/>
         <input type="password" name="senha" size="10" value="<?=$senha ?>" class="form-control"  maxlength="100"
                placeholder="Senha" required="true"/><br/>
         <div class="checkbox">
